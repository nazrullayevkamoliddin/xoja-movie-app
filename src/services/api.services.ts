...
export const API_REQUEST = {
    trending: `${base_url}/trending/all/week?api_key=${api_key}&language=en-US&page=2`,
    topRated: `${base_url}/movie/top_rated?api_key=${api_key}&language=en-US&page=2`,
    tv_topRated: `${base_url}/tv/top_rated?api_key=${api_key}&language=en-US&page=1`,
